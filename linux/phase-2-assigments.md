...
- Extract the base module name (everything before `_v1`)
- Build a new array containing all `v2` filenames
...
- String Manipulation
- File Processing
- Text Processing (`grep`, `wc`, `awk`, `sed`)
- Automation
- Log Analysis
- Basic DevOps Concepts
- RTL Workflow Automation
...
These exercises progressively build practical Linux shell scripting skills for RTL and VLSI development, closely resembling tasks encountered in verification, simulation, build automation, and design workflows.